        ...
        <div class="main_content col-sm-9">
            <form action="" method="post" id="main_form">
                ...
                <div class="main_content_footer row">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo DIR ?>events/demo/pray'; return false;" class="btn btn-primary" disabled="disabled"><?php echo Language::show("next_step", "Events")?></button>
                </div>
            </form>
        </div>
    ...
    <div class="tutorial_popup">
        ...
        <div class="tutorial_pic">
            ...
            <div class="hide_tutorial">
                <label><input id="hide_tutorial" data="content-review" value="0" type="checkbox"> <?php echo Language::show("do_not_show_tutorial", "Events")?></label>
            </div>
        </div>
