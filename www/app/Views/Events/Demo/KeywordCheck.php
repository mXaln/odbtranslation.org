...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", array(7)) . __("keyword-check")?></div>
...
heavenly kingdom. To him be the glory forever and ever. Amen.
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span><?php echo __("step_num", array(7))?></span> <?php echo __("keyword-check")?></div>
