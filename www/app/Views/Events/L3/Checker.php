...
<div id="translator_steps" class="open <?php echo $data["event"][0]->step . (isset($data["isCheckerPage"]) ? " is_checker_page" : " is_checker_page isPeer") ?>">
    ...
    <ul class="steps_list">
        ...
        <li class="peer-review-l3-step <?php echo $data["event"][0]->step == EventCheckSteps::PEER_REVIEW_L3 ? "active" : "" ?>">
            <span><?php echo __(EventCheckSteps::PEER_REVIEW_L3)?></span>
        </li>

        <li class="peer-edit-l3-step <?php echo $data["event"][0]->step == EventCheckSteps::PEER_EDIT_L3 ? "active" : "" ?>">
            <span><?php echo __(EventCheckSteps::PEER_EDIT_L3)?></span>
        </li>
...
<script>
    ...
    var chkMemberID = <?php echo isset($data["event"][0]->chkMemberID) ? $data["event"][0]->chkMemberID : 0 ?>;
    var isChecker = <?php echo json_encode($data["isChecker"]) ?>;
...
<script src="<?php echo template_url("js/socket.js?10")?>"></script>
