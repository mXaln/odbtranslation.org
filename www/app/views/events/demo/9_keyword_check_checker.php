...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo Language::show("step_num", "Events", array(7)) . Language::show("keyword-check", "Events")?></div>
    ...
    <div class="row">
        <div class="main_content col-sm-9">
            <div class="main_content_text row">
                <div class="keywords_show" style=""><?php echo Language::show("show_keywords", "Events"); ?></div>
                ...
                <form action="" method="post" id="checker_submit">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo DIR ?>events/demo/content_review_checker'; return false;" class="btn btn-primary" disabled=""><?php echo Language::show("next_step", "Events")?></button>
                </form>
            </div>
                    </div>
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_descr_steps">
                    <ul><?php echo mb_substr(Language::show("keyword-check" . "_checker_desc", "Events"), 0, 300)?>... <div class="show_tutorial_popup"> >>> <?php echo Language::show("show_more", "Events")?></div></ul>
                </div>
            </div>
    ...
    <div class="tutorial_popup">
        ...
        <div class="tutorial_pic">
            ...
            <div class="hide_tutorial">
                <label><input id="hide_tutorial" data="keyword-check_checker" data2="checker" type="checkbox" value="0"> <?php echo Language::show("do_not_show_tutorial", "Events")?></label>
            </div>
        </div>

        <div class="tutorial_content">
            <h3><?php echo Language::show("keyword-check", "Events")?></h3>
            <ul><?php echo Language::show("keyword-check_checker_desc", "Events")?></ul>
        </div>
    </div>
</div>
