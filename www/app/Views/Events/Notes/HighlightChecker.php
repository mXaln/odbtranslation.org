...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", [4]) . ": " . __("keyword-check_tn_chk")?></div>
    </div>
                ...
                <div id="my_scripture_content" class="my_content shown">
                    <?php $key = 0; foreach($data["text"] as $chunk => $content): ?>
                        <div class="note_chunk chunk_verses">
                            ...
                            <div class="<?php echo "kwverse_".$data["currentChapter"]."_".($data["currentChunk"]-1)."_".$verse ?>">
                                <?php echo $text; ?>
                            </div>
                            <?php endforeach; ?>
                        </div>    
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps<?php echo $data["isCheckerPage"] ? " is_checker_page_help" : "" ?>">
                ...
                <div class="help_name_steps">
                    ...
                    <?php echo __("keyword-check_tn_chk")?>
                </div>
