...
return array (
    ...
    "book_notes" => "Notes Sources",
    "book_questions" => "Questions Sources",
    ...
    "choose_source_notes" => "Choisir Notes Sources",
    "choose_source_questions" => "Choiser Questions Sources",
    "choose_source_words" => "Choisir Mots Sources",
    ...
    "consume_desc" => "<li><b>BUT:</b> Saisir le texte d’origine pour se préparer à traduire.</li>
                        ...
                        <li>Si vous voyez l’icône papier, (<span class='glyphicon glyphicon-file'></span>), glissez la souris dessus. 
    ...
    "error_ocured" => "Une erreur s’est produite. {0}",
