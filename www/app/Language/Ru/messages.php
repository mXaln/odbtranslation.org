...
return array (
    ...
    "password_reset_success" => "Ваш пароль был успешно изменен. Теперь вы можете войти, используя новый пароль <a href=\"{href}\">Войти</a>",
    "activation_link_message" => "<h3>Спасибо за регистрацию!</h3>"."\n"." Чтобы активировать учетную запись перейдите по этой ссылке {link}",
    "account_activated_success" => "Учетная запись активирована. Теперь вы можете <a href=\"{href}\">Войти</a>",
