            ...
            <div class="main_content_text row">
                ...
                <div class="col-sm-12 side_by_side_content">
                                    ...
                                    <div class="col-sm-6 verse_with_note">
                                        ...
                                        <img class="editComment" data="0:0" width="16px" src="<?php echo template_url("img/edit.png") ?>" title="write note">
                ...
                <form action="" method="post" id="checker_submit">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo SITEURL ?>events/demo/pray'; return false;" class="btn btn-primary" disabled=""><?php echo __("next_step")?></button>
                </form>
            </div>
                    </div>
