...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", array(4)) . __("self-check_gl")?></div>
...
own desires. They will be tickling their hearing.
                ...
                <div class="main_content_footer row">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo SITEURL ?>events/demo/self_check_full'; return false;" class="btn btn-primary" disabled="disabled"><?php echo __("next_step")?></button>
                </div>
            </form>
        </div>
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span><?php echo __("step_num", array(4))?></span><?php echo __("self-check_gl")?></div>
                <div class="help_descr_steps">
                    <ul><?php echo mb_substr(__("self-check_gl_desc"), 0, 300)?>... <div class="show_tutorial_popup"> >>> <?php echo __("show_more")?></div></ul>
                </div>
            </div>
...
<div class="tutorial_container">
    <div class="tutorial_popup">
        ...
        <div class="tutorial_content">
            <h3><?php echo __("self-check_gl")?></h3>
            <ul><?php echo __("self-check_gl_desc")?></ul>
        </div>
    </div>
</div>