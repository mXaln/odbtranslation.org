...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo Language::show("consume", "Events")?></div>
    </div>
...
<div class="tutorial_container">
    <div class="tutorial_popup">
        ...
        <div class="tutorial_pic">
            <img src="<?php echo \Helpers\Url::templatePath() ?>img/steps/icons/consume.png" width="100px" height="100px">
            <img src="<?php echo \Helpers\Url::templatePath() ?>img/steps/big/consume.png" width="280px" height="280px">
