                        ...
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="2">
                                    <textarea name="chunks[1][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[1][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 340px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="3">
                                    <textarea name="chunks[2][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[2][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 120px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="4">
                                    <textarea name="chunks[3][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[3][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 280px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="5">
                                    <textarea name="chunks[4][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[4][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 340px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="6">
                                    <textarea name="chunks[5][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[5][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 220px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="7">
                                    <textarea name="chunks[6][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[6][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 360px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="8">
                                    <textarea name="chunks[7][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[7][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 120px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="9">
                                    <textarea name="chunks[8][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[8][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 120px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="10">
                                    <textarea name="chunks[9][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[9][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 160px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="11">
                                    <textarea name="chunks[10][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[10][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 200px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="12">
                                    <textarea name="chunks[11][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[11][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 200px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="13">
                                    <textarea name="chunks[12][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[12][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 200px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="14">
                                    <textarea name="chunks[13][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[13][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 200px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="15">
                                    <textarea name="chunks[14][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[14][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; min-height: 160px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="16">
                                    <textarea name="chunks[15][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[15][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; height: 80px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
                        <div class="flex_container chunk_block no_autosize">
                            ...
                            <div class="flex_middle editor_area" dir="ltr">
                                <div class="vnote verse_block" data-verse="17">
                                    <textarea name="chunks[16][name]" class="peer_verse_ta textarea verse_text_1" rows="1" style="overflow-x: hidden; overflow-wrap: break-word; height: 49px;"></textarea>
                                    <textarea name="chunks[16][text]" class="peer_verse_ta textarea verse_text_2" style="overflow-x: hidden; overflow-wrap: break-word; height: 80px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="chunk_divider"></div>
...
<script>
    $(document).ready(function () {
        $("#next_step").click(function (e) {
            e.preventDefault();
            window.location.href = '/events/demo-rad/self-check';
            return false;
        });
    });
</script>