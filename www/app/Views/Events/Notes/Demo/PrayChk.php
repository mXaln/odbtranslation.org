    ...
    <div class="row">
        ...
        <div class="content_help col-sm-3">
            <div class="help_float">
                <div class="help_info_steps is_checker_page_help <?php echo $data["isPeerPage"] ? "isPeer" : "" ?>">
                ...
                <div class="event_info is_checker_page_help <?php echo $data["isPeerPage"] ? "isPeer" : "" ?>">
