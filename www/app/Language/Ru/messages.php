...
return array (
    ...
    // Index method
    "home" => "Главная",
    "welcome_text" => "Добро пожаловать на ODB Translation!",
    ...
    "send" => "Отправить",
    "facilitator_message_tip" => "Это сообщение было отправлено с сайта odbtranslation.org",
    ...
    "choose_source_trans" => "Выберите исходный текст",
    ...
    "peer-review_mill" => "Взаимопроверка",
    ...
    "content-review_mill" => "Сравнительная проверка",
