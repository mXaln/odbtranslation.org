                ...
                <div id="source_scripture_content" class="col-sm-12 no_padding my_content shown">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 verse_ta textarea sun_content" style="min-height: 170px;"> 
                                            ,                          
                                              ,  ,              </textarea>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 peer_verse_ta textarea sun_content" style="min-height: 260px;">     ”  ,  
                                             ,                     ,       
                                           ”                  ,           
                                              ”      ” </textarea>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 peer_verse_ta textarea sun_content" style="min-height: 150px;">                  ”  
                                                ”       ? “ </textarea>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 peer_verse_ta textarea sun_content" style="min-height: 200px;">    ”           ,         
                                                                         
                                           </textarea>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 peer_verse_ta textarea sun_content" style="min-height: 140px;"> Verse 21 removed in ULB.         
                                          ”                ”     </textarea>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <textarea name="chunks[]"
                                          class="col-sm-6 peer_verse_ta textarea sun_content" style="min-height: 330px;">                 ? “ 
                                          ”  ”     ,      "    ?      ? 
                                          , “  ”    ,                      
                                                             ” </textarea>
                                <div class="comments_number "> </div>
