...
<div id="translator_steps" class="open pray <?php echo $data["isCheckerPage"] ? " is_checker_page" : "" ?>">
    ...
    <ul class="steps_list">
        <li class="pray-step <?php echo $data["step"] == EventSteps::PRAY ? "active" : "" ?>">
            <a href="/events/demo-mill/pray"><span><?php echo __(EventSteps::PRAY)?></span></a>
        </li>

        <li class="consume-step <?php echo $data["step"] == EventSteps::CONSUME ? "active" : "" ?>">
            <a href="/events/demo-mill/consume"><span><?php echo __(EventSteps::CONSUME)?></span></a>
        </li>

        <li class="rearrange-step <?php echo $data["step"] == EventSteps::VERBALIZE ? "active" : "" ?>">
            <a href="/events/demo-mill/verbalize"><span><?php echo __(EventSteps::VERBALIZE)?></span></a>
        </li>

        <li class="symbol-draft-step <?php echo $data["step"] == EventSteps::BLIND_DRAFT ? "active" : "" ?>">
            <a href="/events/demo-mill/draft"><span><?php echo __(EventSteps::BLIND_DRAFT."_mill")?></span></a>
        </li>

        <li class="self-check-step <?php echo $data["step"] == EventSteps::SELF_CHECK ? "active" : "" ?>">
            <a href="/events/demo-mill/self-check"><span><?php echo __(EventSteps::SELF_CHECK)?></span></a>
        </li>

        <li class="theo-check-step <?php echo $data["step"] == EventSteps::PEER_REVIEW ? "active" : "" ?>">
            <a href="/events/demo-mill/peer_review_checker"><span><?php echo __(EventSteps::PEER_REVIEW)?></span></a>
        </li>

        <li class="content-review-step <?php echo $data["step"] == EventSteps::CONTENT_REVIEW ? "active" : "" ?>">
            <a href="/events/demo-mill/content_review_checker"><span><?php echo __(EventSteps::CONTENT_REVIEW."_mill")?></span></a>
        </li>
    </ul>
</div>
