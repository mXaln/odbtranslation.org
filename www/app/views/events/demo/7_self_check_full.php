        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_descr_steps">
                    <ul><?php echo mb_substr(Language::show("self-check-full_desc", "Events"), 0, 300)?>... <div class="show_tutorial_popup"> >>> <?php echo Language::show("show_more", "Events")?></div></ul>
                </div>
            </div>
            ...
            <div class="event_info">
                <div class="participant_info">
                    ...
                    <div class="participant_name">
                        ...
                        <span class="checker_name_span">N/A</span>
                    </div>
