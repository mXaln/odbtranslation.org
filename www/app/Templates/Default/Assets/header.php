	...
	<div class="header page-header row <?php echo Session::get("loggedin") ? "loggedin" : ""?>">
		...
		<div class="col-sm-8 row header_menu_left">
			...
			<?php if(Session::get('loggedin')): ?>
				<li <?php if($data['menu'] == 1):?>class="active"<?php endif?> role="presentation"><a href="<?php echo SITEURL?>"><?php echo Language::show('home', 'Main')?></a></li>
				<li <?php if($data['menu'] == 4):?>class="active"<?php endif?> role="presentation"><a href="<?php echo SITEURL?>events"><?php echo Language::show('events_title', 'Main')?></a></li>
				<li <?php if($data['menu'] == 3):?>class="active"<?php endif?> role="presentation"><a href="<?php echo SITEURL?>translations"><?php echo Language::show('translations_title', 'Main')?></a></li>
				<!--<li <?php if($data['menu'] == 5):?>class="active"<?php endif?> role="presentation"><a href="<?php echo SITEURL?>contact"><?php echo Language::show('contact_us_title', 'Main')?></a></li>
				<li <?php if($data['menu'] == 6):?>class="active"<?php endif?> role="presentation"><a href="<?php echo SITEURL?>about"><?php echo Language::show('about_title', 'Main')?></a></li>-->
			<?php endif; ?>
			</ul>
		</div>
		...
		<ul class="list-inline col-sm-4 header_menu_right">
			...
			<li class="notifications">
				...
				<?php endif; ?>
					<div class="all_notifs"><a href="<?php echo SITEURL?>events/notifications"><?php echo Language::show("see_all", "Events") ?></a></div>
				</ul>
			</li>
			<li>
