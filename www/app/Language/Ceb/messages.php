...
return array (
    ...
    "mast_facilitator_public" => "Natudloan na sa paggiya sa MAST",
    ...
    "8steps_mast" => "Walo(8) ka mga Lakang sa MAST",
    "mast" => "8 Steps MAST",
    ...
    "level2" => "Level 2",
    "level3" => "Level 3",
    "l2_l3_mast" => "MAST L{level} Pagsusi",
    "common" => "Common",
