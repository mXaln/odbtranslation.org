...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", array(2)) . ": " . __("verbalize_tn")?></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span><?php echo __("step_num", [2])?>: </span><?php echo __("verbalize_tn")?></div>
