...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title">Self Check</div>
...
own desires. They will be tickling their hearing.
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span>Step 5:</span> Self Check</div>
                <div class="help_descr_steps">
                    <ul><li><b>PURPOSE:</b> to ensure nothing is missed or added that is not in the original.</li><li>First,
 segment your translated text into the appropriate verses, either by 
copy and pasting from the block text to the verse boxes, or by 
re-writing into the verse boxes.</li><li>Open the source text and re... <div class="show_tutorial_popup"> &gt;&gt;&gt; Show more</div></li></ul>
                </div>
            </div>
...
<div class="tutorial_container">
 ...
 segment your translated text into the appropriate verses, either by 
copy and pasting from the block text to the verse boxes, or by 
re-writing into the verse boxes.</li><li>Open the source text and review
 your translation. Look for anything that seems to be missing and add 
it. Likewise look for too much and remove what is not in the original. 
Thirdly, correct anything that is misstated.</li><li>Do not over 
analyze. The goal in this step is not perfection, but text that is 
essentially correct. Anything that truly mystifies you, record in a 
simple note on the appropriate verse, and move on.</li><li>Spend no more than 10-12 minutes on this exercise.</li></ul>
        </div>
    </div>
</div>
