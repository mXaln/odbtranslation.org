<div id="translator_contents" class="row panel-body">
    <div class="row">
        <div class="main_content_title">Discussion of text</div>
    </div>

    <div class="row">
        <div class="main_content col-sm-9">
            <div class="main_content_text">
                sdrgkh sbkrghsbkhgk hegk sheg ksheb gkshvb vsghsueh gsuehkugskeu gksueg
                kusekgusefuseoui gsleu gslueg sueg fksuegk fusegku fgskeug fksueg fkusegfkuseg kfusgek fugseku
            </div>
