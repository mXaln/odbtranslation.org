<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", [1]) . ": " . __("consume")?></div>
        ...
        <div class="main_content col-sm-9">
            ...
            <div class="main_content_footer row">
                <form action="" method="post">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo SITEURL ?>events/demo/verbalize'; return false;" class="btn btn-primary" disabled="disabled"><?php echo __("next_step")?></button>
                </form>
            </div>
        </div>
