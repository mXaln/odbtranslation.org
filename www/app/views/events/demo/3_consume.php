...
heavenly kingdom. To him be the glory forever and ever. Amen.
                ...
                <form action="" method="post">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo DIR ?>events/demo/verbalize'; return false;" class="btn btn-primary" disabled="disabled"><?php echo Language::show("next_step", "Events")?></button>
                </form>
            </div>
                    </div>
    ...
    <div class="tutorial_popup">
        ...
        <div class="tutorial_pic">
            ...
            <div class="hide_tutorial">
                <label><input id="hide_tutorial" data="consume" value="0" type="checkbox"> <?php echo Language::show("do_not_show_tutorial", "Events")?></label>
            </div>
        </div>

        <div class="tutorial_content">
            <h3><?php echo Language::show("consume", "Events")?></h3>
