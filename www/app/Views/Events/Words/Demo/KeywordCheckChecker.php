    ...
    <div class="row">
                ...
                <div class="main_content_text row" style="padding-left: 15px">
                    ...
                    <div class="col-sm-12 no_padding questions_bd">
                        <div class="parent_q questions_chunk" data-question="1" data-chapter="1" data-event="0">
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Аарон</h1>
                                    <h2>Факты:</h2>
                                    ...
                                    <p>(См. также:&nbsp;
                                        ...
                                        <a href="../kt/israel.md" rel="nofollow">Израиль</a>)</p></div>
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Авель</h1>
                                    ...
                                    <p>(См. также:&nbsp;
                                        ...
                                        <a href="../other/shepherd.md">пастух, пасти</a>)</p></div>
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Авиафар</h1>
                                    ...
                                    <p>(См. также:&nbsp;
                                        ...
                                        <a href="../names/adonijah.md">Адония</a>)</p></div>
                        ...
                        <div class="parent_q questions_chunk" data-question="6" data-chapter="1" data-event="0">
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Авия</h1>
                                    ...
                                    <p>(Варианты перевода:&nbsp;
                                        <a href="rc://en/ta/man/translate/translate-names" target="_blank" rel="noopener">Как переводить имена</a>)</p></div>
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Авимелех</h1>
                                    ...
                                    <p>(См. также:&nbsp;
                                        ...
                                        <a href="../names/philistines.md">филистимляне</a>)</p></div>
                        ...
                        <div class="parent_q questions_chunk" data-question="10" data-chapter="1" data-event="0">
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Авессалом</h1>
                                    ...
                                    <p>(Варианты перевода: Как переводить имена)</p>
                                    <p>(См. также:&nbsp;
                                        <a href="../names/geshur.md">Гессур</a>,&nbsp;<a href="../names/amnon.md">Амнон</a>)</p></div>
                            ...
                            <div class="col-md-6 font_ru" dir="ltr">
                                <div><h1>Адам</h1>
                                    ...
                                    <p>(См. Также:&nbsp;
                                        ...
                                        <a href="../kt/life.md">жизнь, жить, живой, живущий</a>)</p></div>
        ...
        <div class="content_help col-sm-3">
            ...
            <div class="checker_view">
                <a href="<?php echo SITEURL ?>events/demo-tw/keyword_check"><?php echo __("translator_view") ?></a>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#next_step").click(function (e) {
            e.preventDefault();
            window.location.href = '/events/demo-tw/peer_review';
            return false;
        });
    });
</script>