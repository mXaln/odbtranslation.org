...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo Language::show("step_num", "Events", array(5)) . Language::show("self-check", "Events")?></div>
...
own desires. They will be tickling their hearing.
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span><?php echo Language::show("step_num", "Events", array(5))?></span> <?php echo Language::show("self-check", "Events")?></div>
                <div class="help_descr_steps">
                    <ul><?php echo mb_substr(Language::show("self-check_desc", "Events"), 0, 300)?>... <div class="show_tutorial_popup"> >>> <?php echo Language::show("show_more", "Events")?></div></ul>
                </div>
            </div>
...
<div class="tutorial_container">
    <div class="tutorial_popup">
        ...
        <div class="tutorial_content">
            <h3><?php echo Language::show("self-check", "Events")?></h3>
            <ul><?php echo Language::show("self-check_desc", "Events")?></ul>
        </div>
    </div>
</div>