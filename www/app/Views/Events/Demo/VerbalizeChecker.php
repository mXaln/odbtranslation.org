        ...
        <div class="main_content col-sm-9">
            ...
            <div class="main_content_footer row">
                <form action="" method="post" id="checker_submit">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo SITEURL ?>events/demo/chunking'; return false;" class="btn btn-primary" disabled=""><?php echo __("next_step")?></button>
                </form>
            </div>
        </div>
