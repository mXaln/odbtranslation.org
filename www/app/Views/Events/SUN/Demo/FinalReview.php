                ...
                <div class="col-sm-12">
                    <div class="row chunk_block">
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                ...
                                <div contenteditable="true" class="textWithBubbles sun_content">
                                    <div class="splword" contenteditable="true">
                                        <div class="bubble" draggable="true" id="1518189129511" contenteditable="false">1</div>
                                             ,             
                                        <div class="bubble" draggable="true" id="1518189130999" contenteditable="false">2</div>
                                                        
                                    </div>
                                </div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                ...
                                <div contenteditable="true" class="textWithBubbles sun_content">
                                    <div class="splword" contenteditable="true">
                                        <div class="bubble" draggable="true" id="1518189129511" contenteditable="false">3</div>
                                         ,  ,                  ”  ,
                                               ,                  </div>
                                </div>
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    ...
                                    <div contenteditable="false" class="bubble" draggable="true">6</div>
                                    <div contenteditable="false" class="bubble" draggable="true">7</div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    <div contenteditable="false" class="bubble" draggable="true">10</div>
                                    <div contenteditable="false" class="bubble" draggable="true">11</div>
                                    <div contenteditable="false" class="bubble" draggable="true">12</div>
                                    <div contenteditable="false" class="bubble" draggable="true">13</div>
                                </div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    <div contenteditable="false" class="bubble" draggable="true">14</div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    <div contenteditable="false" class="bubble" draggable="true">17</div>
                                    <div contenteditable="false" class="bubble" draggable="true">18</div>
                                </div>
                    ...
                    <div class="row chunk_block">
                        <div style="padding: 0 15px 0 0;" class="chunk_verses col-sm-6">
                            ...
                            <div> <strong class="ltr"> <sup>20</sup> </strong> <div class="kwverse_2_0_20">Jesus said to them,
                                    "Because of your small faith. For I truly say to you, if you have faith even as small
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    <div contenteditable="false" class="bubble" draggable="true">19</div>
                                    <div contenteditable="false" class="bubble" draggable="true">20</div>
                                </div>
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    ...
                                    <div contenteditable="false" class="bubble" draggable="true">23</div>
                                </div>

                                <div contenteditable="true" class="textWithBubbles sun_content">
                                    <div class="splword" contenteditable="true"> Verse 21 removed in ULB.         
                                          ”                ”     </div>
                                </div>
                    ...
                    <div class="row chunk_block">
                        <div style="padding: 0 15px 0 0;" class="chunk_verses col-sm-6">
                            ...
                            <div> <strong class="ltr"> <sup>25</sup> </strong> <div class="kwverse_2_0_25">He said, "Yes."
                                    When Peter came into the house, Jesus spoke to him first and said, "What do you think,
                                    Simon? From whom do the kings of the earth collect tolls or taxes? From their sons
                                    or from others?"</div></div>
                            <div> <strong class="ltr"> <sup>26</sup> </strong> <div class="kwverse_2_0_26">When he said,
                                    "From others," Jesus said to him, "Then the sons are free..</div></div>
                            <div> <strong class="ltr"> <sup>27</sup> </strong> <div class="kwverse_2_0_27">But so that
                        ...
                        <div style="padding: 0;" class="col-sm-6 editor_area">
                            <div class="vnote">
                                <div class="markerBubbles noselect">
                                    <div contenteditable="false" class="bubble" draggable="true">24</div>
                                    <div contenteditable="false" class="bubble" draggable="true">25</div>
                                    <div contenteditable="false" class="bubble" draggable="true">26</div>
                                    <div contenteditable="false" class="bubble" draggable="true">27</div>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#next_step").click(function (e) {
            ...
            window.location.href = '/events/demo-sun/information';
