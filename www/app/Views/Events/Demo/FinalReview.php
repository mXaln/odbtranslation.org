        ...
        <div class="main_content col-sm-9">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row chunk_block">
                        <div style="padding: 0 15px 0 0;" class="chunk_verses col-sm-6">
                            ...
                            <strong><sup>14</sup></strong>Keep reminding them of these things. Warn them before God not to quarrel about words. Because of this there is nothing useful. Because of this there is destruction for those who listen.
            ...
            <div class="main_content_footer row">
                <form action="" method="post">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo SITEURL ?>events/demo/pray'; return false;" class="btn btn-primary" disabled="disabled"><?php echo __("next_step")?></button>
                </form>
            </div>
        </div>
