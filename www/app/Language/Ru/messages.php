...
return array (
    ...
    "checker_apply_tw" => "<b>{0}</b> готов(а) для проверки <b>{1}</b> категории <b>{2}</b>, группы <b>{3}</b> - <b>{4}</b> - <b>{5}</b>",
    ...
    "compare" => "Сравнить",
    "compare_hint" => "Сравнить текст проверяющего с текстом переводчика",
