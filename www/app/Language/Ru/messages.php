...
return array (
    ...
    "final-review_desc" => "<li><b>PURPOSE:</b> это последний обзор, где вы можете проставить нумерацию к стихам в переведенном тексте.</li><li>Прочтите переведенный текст и сравните с исходным текстом, затем нажмите на нумерацию и перетащите ее к правильному стиху в переведенном тексте.</li><li>Уделите этому шагу не более 10 минут.</li>",
    "finished" => "Завершено",
