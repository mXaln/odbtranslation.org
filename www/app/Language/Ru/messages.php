...
return array (
    ...
    "wrong_event_state_error" => "Перевод книги еще не начался. Пожалуйста ждите, пока фасилитатор не начнет его.",
    ...
    "event_translating_error" => "Вы не можете назначать главы и пары, когда книга уже переводится.",
