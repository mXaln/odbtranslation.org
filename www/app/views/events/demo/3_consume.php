<div id="translator_steps" class="open consume">
    <div id="tr_steps_hide" class="glyphicon glyphicon-chevron-left consume"></div>

    <ul class="steps_list">
        <li class="pray-step ">
            <span>Pray</span>
        </li>
        <li class="consume-step active">
...
<div id="chat_container" class="closed">
    ...
    <div class="members_online panel panel-info">
        ...
        <ul id="online" class="panel-body"><li class="mine">mpat1977</li></ul>
    </div>
...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title">Consume Text</div>
...
heavenly kingdom. To him be the glory forever and ever. Amen.
                ...
                <form action="" method="post">
                    ...
                    <button id="next_step" onclick="window.location.href='<?php echo DIR ?>events/demo/verbalize'; return false;" class="btn btn-primary" disabled="disabled">Next step</button>
                </form>
            </div>
                    </div>
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps">
                ...
                <div class="help_name_steps"><span>Step 1:</span> Consume Text</div>
                <div class="help_descr_steps">
                    <ul><li><b>PURPOSE:</b> to prepare your short-term memory to assist you in translation</li><li>Read
 the assigned text in its entirety. Carefully absorb and consider what 
is being addressed to understand the full content of the passage.</li><li>Pause, reflect, and re-read as necessary.</li><li>Spend no m... <div class="show_tutorial_popup"> &gt;&gt;&gt; Show more</div></li></ul>
                </div>
            </div>
...
<div class="tutorial_container">
    <div class="tutorial_popup">
        ...
        <div class="tutorial_pic">
            <img src="<?php echo \Helpers\Url::templatePath() ?>img/steps/icons/consume.png" height="100px" width="100px">
            <img src="<?php echo \Helpers\Url::templatePath() ?>img/steps/big/consume.png" height="280px" width="280px">
            <div class="hide_tutorial">
                <label><input id="hide_tutorial" data="consume" value="0" type="checkbox"> Don't show this message again</label>
            </div>
        </div>
        ...
        <div class="tutorial_content">
            ...
            <ul><li><b>PURPOSE:</b> to prepare your short-term memory to assist you in translation</li><li>Read
 the assigned text in its entirety. Carefully absorb and consider what 
is being addressed to understand the full content of the passage.</li><li>Pause, reflect, and re-read as necessary.</li><li>Spend no more than 10-11 minutes on this activity.</li></ul>
        </div>
    </div>
</div>
