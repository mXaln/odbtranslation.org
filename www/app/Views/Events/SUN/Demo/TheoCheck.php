...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title">
            ...
            <div><?php echo __("step_num", [6]) . ": " . __("theo-check")?></div>
        </div>
    ...
    <div class="row">
        <div class="main_content col-sm-9">
                ...
                <div class="no_padding">
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"><p>You are like a son to me. So I urge also that you let God empower you as a result of Christ Jesus acting kindly toward you.
                                Command and trust faithful men to teach the things you heard from me and from many others who have testified in the same way to others, too.
                                Endure as I do what we suffer for Christ Jesus, like a what he suffers.</p></div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>You know that soldiers, in order to please their captain, do not become involved in civilian affairs
                                Likewise, athletes competing in games cannot win unless they obey the rules.
                                And the farmer who works hard must receive his share of the crops first.
                                Think about what I have just written, because, if you do, the Lord will enable you to understand everything that you need to understand.</p> </div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>As you suffer hardships, remember Jesus Christ, a descendant of King David. God raised him from the dead, as I also preach in the gospel message.
                                For this gospel I suffer to the point of being imprisoned as a criminal. But the word of God is not in prison.
                                Therefore I willingly endure all that I am suffering for the sake of those whom God has chosen. I do this in order that Christ Jesus will save them, too, and that they will be forever with him in the glorious place where he is.</p> </div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>You can depend on the words that we sometimes say: "If we have died with Jesus, we will also live with him.
                                If we endure, we will also reign with him. But if we deny him, he also will deny us.
                                If we are unfaithful to Jesus, he continues to be faithful; for he cannot deny himself."
                                Those whom you appointed to teach others God's truth, keep reminding them about these things that I have told you. Warn them before God not to fight over foolish words, because doing so does not help anything and can ruin those who listen.</p> </div>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                                <div class="clear"></div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>Do your best to cause God to approve you as a worker who has no need to be ashamed, who teaches the word of God correctly, for everyone can depend on the fact that it tells the truth.
                                Stay away from people who talk in ways that insult God, because this kind of talk dishonors God more and more.
                                This kind of words will spread like an infectious disease. Hymenaeus and Philetus are two examples of men who talk like this.</p> </div>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                                <div class="clear"></div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>These men have stopped believing. They say that the resurrection of the dead has already happened. In this way they convince some Christians to stop trusting in Christ.
                                However, the truth about God still exists. It is like a firm foundation of a building, on which someone has written these words: "The Lord knows those who belong to him," and, "Everyone who says he belongs to the Lord must stop doing wicked deeds."
                                In a wealthy person's house there are not only utensils made of gold and of silver, but also utensils made of wood and of clay. The gold and silver utensils are used on special occasions. But the wood and clay utensils are used in ordinary times.</p> </div>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                                <div class="clear"></div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>Therefore, those who rid themselves of what is evil in their lives will be able to work well for the Lord. They will be like utensils ready to do any kind of good work. They will become very useful to the Master to do special work for him, every good deed, in fact.
                                Do not keep on wanting the sinful things that young people usually desire. Instead, try to do right things. Try to trust in God and love him. Try to live in peace. Stay together with the people who worship the Lord sincerely.
                                Do not talk with anyone who foolishly wants to argue about matters that are not important. Do not talk with them, because you know that when people talk about foolish things, they begin to quarrel.</p> </div>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                                <div class="clear"></div>
                    ...
                    <div class="row chunk_block">
                        ...
                        <div class="col-sm-6 editor_area" dir="ltr">
                            <div class="vnote">
                                <div class="verse_block"> <p>But those who serve the Lord must not quarrel. Instead, they should be kind to all people, they should be able to teach God's truth well, and they should be patient with people.
                                That is, they should gently instruct the people who argue against them. Perhaps God may give them the opportunity to repent and come to know the truth.
                                In that way they may think correctly and be like people who have escaped from a trap set by the devil. It is the devil who has deceived them in order to get them to do what he wishes them to do.</p> </div>
                                <div class="comments_number "> </div>
                                <img class="editComment" data="0:0" src="<?php echo template_url("img/edit.png") ?>" title="<?php echo __("write_note_title")?>" width="16">
                                <div class="comments"> </div>
                                <div class="clear"></div>
            ...
            <div class="main_content_footer row">
                ...
                <div class="step_right"><?php echo __("step_num", [6])?></div>
            </div>
        </div>
        ...
        <div class="content_help col-sm-3">
            <div class="help_info_steps is_checker_page_help">
                ...
                <div class="help_name_steps"><span><?php echo __("step_num", [6])?>:</span> <?php echo __("theo-check")?></div>
